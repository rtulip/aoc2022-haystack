...
fn_Range_dot_contains:
  ...
  mov  qword [frame_start_ptr], rax
  ret
; fn Range.strictly_less_than
fn_Range_dot_strictly__less__than:
  pop rax
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  mov  [rbx], rax
...
fn_Ranges_dot_from__line:
  ...
  push 0
  ; -- JumpDest { id: 0 }
fn_Ranges_dot_from__line_jmp_dest_0:
  ; -- PushToFrame { quad_words: 1 }
  pop  rax
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  ...
  pop  rax
  test rax, rax
  jz fn_Ranges_dot_from__line_jmp_dest_1
  ; -- StartBlock
  ; -- PushU64(1)
  push 1
  ; -- Operator { op: Plus, size: None }
  ...
  add qword [frame_end_ptr], 0
  ; -- Jump { dest_id: 0 }
  jmp fn_Ranges_dot_from__line_jmp_dest_0
  ; -- JumpDest { id: 1 }
fn_Ranges_dot_from__line_jmp_dest_1:
  ; -- PushFromFrame { offset_from_end: 0, bytes: 2 }
  mov rax, [frame_end_ptr]
  add rax, 0
  mov rbx, [rax]
  ...
  mov  rax, [frame_end_ptr]
  mov  qword [frame_start_ptr], rax
  call fn_swap_Str_Str_ ; -- swap<Str Str>
  ; -- Call("Str.parse_u64")
  mov rax, [frame_start_ptr]
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  ...
  push 0
  ; -- JumpDest { id: 3 }
fn_Ranges_dot_from__line_jmp_dest_3:
  ; -- PushToFrame { quad_words: 1 }
  pop  rax
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  ...
  pop  rax
  test rax, rax
  jz fn_Ranges_dot_from__line_jmp_dest_4
  ; -- StartBlock
  ; -- PushU64(1)
  push 1
  ; -- Operator { op: Plus, size: None }
  ...
  add qword [frame_end_ptr], 0
  ; -- Jump { dest_id: 3 }
  jmp fn_Ranges_dot_from__line_jmp_dest_3
  ; -- JumpDest { id: 4 }
fn_Ranges_dot_from__line_jmp_dest_4:
  ; -- PushFromFrame { offset_from_end: 1, bytes: 2 }
  mov rax, [frame_end_ptr]
  add rax, 8
  mov rbx, [rax]
  ...
  push 0
  ; -- JumpDest { id: 6 }
fn_Ranges_dot_from__line_jmp_dest_6:
  ; -- PushToFrame { quad_words: 1 }
  pop  rax
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  ...
  pop  rax
  test rax, rax
  jz fn_Ranges_dot_from__line_jmp_dest_7
  ; -- StartBlock
  ; -- PushU64(1)
  push 1
  ; -- Operator { op: Plus, size: None }
  ...
  add qword [frame_end_ptr], 0
  ; -- Jump { dest_id: 6 }
  jmp fn_Ranges_dot_from__line_jmp_dest_6
  ; -- JumpDest { id: 7 }
fn_Ranges_dot_from__line_jmp_dest_7:
  ; -- PushFromFrame { offset_from_end: 2, bytes: 2 }
  mov rax, [frame_end_ptr]
  add rax, 16
  mov rbx, [rax]
...
fn_part1_jmp_dest_0:
  ...
  mov  rax, [frame_end_ptr]
  mov  qword [frame_start_ptr], rax
  call fn_Ranges_dot_from__line ; -- Ranges.from_line
  ; -- PushToFrame { quad_words: 2 }
  pop  rax
  sub  qword [frame_end_ptr], 8
  mov  rbx, [frame_end_ptr]
  ...
  mov  rax, [frame_end_ptr]
  mov  qword [frame_start_ptr], rax
  call fn_Range_dot_contains ; -- Range.contains
  ; -- PushFromFrame { offset_from_end: 2, bytes: 2 }
  mov rax, [frame_end_ptr]
  add rax, 16
  mov rbx, [rax]
...
fn_part2_jmp_dest_0:
  ...
  mov  rax, [frame_end_ptr]
  mov  qword [frame_start_ptr], rax
  call fn_Range_dot_strictly__less__than ; -- Range.strictly_less_than
  ; -- PushFromFrame { offset_from_end: 2, bytes: 2 }
  mov rax, [frame_end_ptr]
  add rax, 16
  mov rbx, [rax]
...
fn_println_Range_:
  ...
  mov  rax, [frame_end_ptr]
  mov  qword [frame_start_ptr], rax
  call fn_print_Range_ ; -- print<Range>
  ; -- PushU64(1)
  push 1
...
segment .data
  ...
  str_32: db 0x41, 0x73, 0x73, 0x65, 0x72, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 
  str_26: db 0x43, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x20, 0x74, 0x61, 0x6b, 0x65, 0x20, 0x73, 0x75, 0x62, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x20, 0x77, 0x68, 0x65, 0x72, 0x65, 0x20, 0x65, 0x6e, 0x64, 0x20, 0x28, 
  str_33: db 0x74, 0x72, 0x75, 0x65, 
  str_48: db 0x53, 0x69, 0x7a, 0x65, 0x20, 0x60, 
  ...
  str_42: db 0x61, 0x6f, 0x63, 0x32, 0x30, 0x32, 0x32, 0x2f, 0x64, 0x61, 0x79, 0x34, 0x2f, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x2e, 0x74, 0x78, 0x74, 
  str_11: db 0x20, 0x7c, 0x20, 
  str_50: db 0x45, 0x72, 0x72, 0x6f, 0x72, 0x3a, 0x20, 0x6d, 0x6d, 0x61, 0x70, 0x20, 0x63, 0x61, 0x6c, 0x6c, 0x20, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x2e, 0x2e, 0x2e, 
  chunks_p: dq 100000, data_0
  str_35: db 0x43, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x20, 0x70, 0x61, 0x72, 0x73, 0x65, 0x20, 0x75, 0x38, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x6e, 0x6f, 0x6e, 0x2d, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x20, 0x63, 0x68, 0x61, 0x72, 0x3a, 0x20, 
  str_43: db 0x50, 0x61, 0x72, 0x74, 0x20, 0x31, 0x20, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x3a, 0x20, 
  str_37: db 0x66, 0x61, 0x6c, 0x73, 0x65, 
